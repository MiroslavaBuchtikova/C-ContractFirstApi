...
namespace ContractFirstApi.Tests.Clients.V1
{
    ...
    public partial interface IClient
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Pet>> PetsGetAsync(int? limit);
        ...
        /// <returns>A paged array of pets</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Pet>> PetsGetAsync(int? limit, System.Threading.CancellationToken cancellationToken);
    
        /// <summary>Create a pet</summary>
        /// <returns>Null response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task PetsPostAsync();
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Create a pet</summary>
        /// <returns>Null response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task PetsPostAsync(System.Threading.CancellationToken cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Pet> PetsGetAsync(string petId);
        ...
        /// <returns>Expected response to a valid request</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Pet> PetsGetAsync(string petId, System.Threading.CancellationToken cancellationToken);
